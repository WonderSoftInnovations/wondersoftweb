    ...
    <div class="header-area">
      ...
      <div id="main-wrapper">
        <div class="site-wrapper-reveal">
                ...
                <div class="col-lg-12">
                  ...
                  >
                    ...
                    <h3 class="heading">
                      ...
                      >
                      & climbed up
                      <span class="text-color-primary">the top.</span>
                    </h3>
                  </div>
                  <!-- section-title-wrap Start -->
                </div>
                  ...
                  <div class="col-lg-5 offset-lg-1">
                    <div class="modern-number-01 number-two">
                      <h2 class="heading mr-5">
                        <span class="mark-text">We</span>Just dont build things
                      </h2>
                      <h5 class="heading mt-30">
                        In wondersoft We build
                        <span class="text-color-primary"> Wonders. </span>
                          ...
                          >
                            <div class="card-body">
                              <p>
                                ...
                                discussing needs and demand, we're able to
                                attain mutual understanding, gain customer trust
                                to offer appropriate advice, and bring about
                                suggestions on suitable technology to transform
                                your business.
                              </p>
                            </div>
                          </div>
                        ...
                        <div class="card">
                          <div class="card-header" id="headingTwo">
                            <h5 class="mb-0">
                              ...
                              >
                                What are the advantages of Wondesoft?<span>
                                  <i class="fas fa-chevron-down"></i>
                                  <i class="fas fa-chevron-up"></i>
                                </span>
                              </button>
                          ...
                          >
                            <div class="card-body">
                              <p>
                                Wondersoft takes into consideration every little
                          ...
                          >
                            <div class="card-body">
                              <p>
                                ...
                                to ensure Wondersoft would run seamlessly and the
              ...
              <div class="row">
                <div class="col-lg-7">
                  <div class="section-title-wrap text-left">
                    <h3 class="section-title mb-15 wow move-up">
                      Bring your bussiness to the
                      <span class="text-color-primary"> spotlight. </span> We
                      Make your business a 
                      <span class="text-color-primary"> Wonder.</span>
                    </h3>
                ...
                <div class="col-lg-5 wow move-up animate">
                  <div class="about-button mt-30">
                    <a href="#" class="ht-btn ht-btn-md">Ask Now</a>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <div class="gallery-warp popup-images">
                      ...
                      <a
                        class="single-gallery gallery-grid wow move-up"
                        href="https://demo.hasthemes.com/mitech-preview/assets/images/gallery/blog-07-960x960.jpg"
                      >
                        <div class="single-gallery__item">
                          <div
                            class="single-gallery__thum bg-item-images bg-img"
                            data-bg="https://demo.hasthemes.com/mitech-preview/assets/images/gallery/blog-07-960x960.jpg"
                          ></div>
                      ...
                      <a
                        class="single-gallery gallery-grid wow move-up"
                        href="https://demo.hasthemes.com/mitech-preview/assets/images/gallery/careers-gallery-image-01-960x960.jpg"
                      >
                        <div class="single-gallery__item">
                          <div
                            class="single-gallery__thum bg-item-images bg-img"
                            data-bg="https://demo.hasthemes.com/mitech-preview/assets/images/gallery/careers-gallery-image-01-960x960.jpg"
                          ></div>
                          <div class="ht-overlay"></div>
                          <div class="overlay-icon">
                            <i class="far fa-search"></i>
                      ...
                      <a
                        class="single-gallery gallery-grid wow move-up"
                        href="https://demo.hasthemes.com/mitech-preview/assets/images/gallery/blog-08-960x960.jpg"
                      >
                        <div class="single-gallery__item">
                          <div
                            class="single-gallery__thum bg-item-images bg-img"
                            data-bg="https://demo.hasthemes.com/mitech-preview/assets/images/gallery/blog-08-960x960.jpg"
                          ></div>
                          <div class="ht-overlay"></div>
                          <div class="overlay-icon">
                            <i class="far fa-search"></i>
                      ...
                      <a
                        class="single-gallery gallery-grid wow move-up"
                        href="https://demo.hasthemes.com/mitech-preview/assets/images/gallery/blog-06-960x960.jpg"
                      >
                        <div class="single-gallery__item">
                          <div
                            class="single-gallery__thum bg-item-images bg-img"
                            data-bg="https://demo.hasthemes.com/mitech-preview/assets/images/gallery/blog-06-960x960.jpg"
                          ></div>
                          <div class="ht-overlay"></div>
                          <div class="overlay-icon">
                            <i class="far fa-search"></i>
          ...
          <div
            class="feature-icon-wrapper section-space--pb_80 section-space--pt_80 border-bottom"
          >
            <div class="container">
              <div class="row">
                <div class="col-12">
                          ...
                          <div class="ht-box-icon style-03">
                            <div class="icon-box-wrap">
                              <div class="content-header">
                                ...
                                <h5 class="heading">Smart API Generation</h5>
                              </div>
                              <div class="content">
                                <div class="text">
                                  Develop and propose product improvements
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="contact-title section-space--mb_50">
                    ...
                    <p class="sub-title">
                      Spaming email will instantly ignore your email
                    </p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-6">
                  <div class="contact-form-wrap">
                    ...
                    <form
                      class="contact-form"
                      id="contact-form"
                      action="https://demo.hasthemes.com/mitech-preview/assets/php/services-mail.php"
                      method="post"
                    >
                ...
                <div class="col-lg-5 ml-auto">
                  <div class="contact-info-three text-left">
                    ...
                    <h3 class="call-us">
                      <a href="tel:123 567990">0704317146</a>
                    </h3>
                    <div class="text">
                      Start Your business with us. Let us build the best digital solution for you
                    </div>
                    <!-- <div class="location-button mt-20">
                      <a href="#" class="location-text-button"
