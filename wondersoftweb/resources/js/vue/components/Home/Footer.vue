        ...
        <div class="row footer-widget-wrapper">
          <div class="col-lg-4 col-md-6 col-sm-6 footer-widget">
            <div class="footer-widget__logo mb-30">
              <!-- <img
                src="https://demo.hasthemes.com/mitech-preview/assets/images/logo/dark-logo-160x48.png"
                class="img-fluid"
                alt=""
              /> -->
              <h2>WonderSoft</h2>
            ...
            <ul class="footer-widget__list">
              <li>No 80/3 Ambalangoda, Polgasowita, Sri Lanka 10320</li>
              <li>
                <a href="mailto:contact@aeroland.com" class="hover-style-link"
                  >contact@wondersoftinno.com</a
                >
              </li>
              <li>
                <a
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 footer-widget">
            ...
            <h6 class="footer-widget__title mb-20">Contact Us Via</h6>
            <ul class="footer-widget__list">
              <li>
                <a href="#" class="image_btn"
                  ><img
                    class="img-fluid social-link hint--bounce hint--top hint--primary"
                    aria-label="Twitter"
                    src="https://demo.hasthemes.com/mitech-preview/assets/images/icons/aeroland-button-google-play.jpg"
                    alt=""
                /></a>
              </li>
              <li>
                <a href="#" class="image_btn"
                  ><img
                    class="img-fluid"
                    src="https://demo.hasthemes.com/mitech-preview/assets/images/icons/aeroland-button-app-store.jpg"
                    alt=""
                /></a>
              </li>
            </ul>
